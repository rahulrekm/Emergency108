...
public class PoliceAlertFragment extends DialogFragment {
        ...
        String [] noInjured = {"0","1","2","3","4","5","more"};
        String [] type = {"Accident","Traffic","Fight","Thieves"};
        ...
        public static PoliceAlertFragment newInstance(int title){
            PoliceAlertFragment fragment = new PoliceAlertFragment();
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            final View view =  inflater.inflate(R.layout.dialog_police, container,false);
