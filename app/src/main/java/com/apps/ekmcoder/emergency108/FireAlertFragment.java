...
public class FireAlertFragment  extends DialogFragment {
        ...
        String [] type = {"Accident","Vehicle","Building","Massive"};
        ...
        public static FireAlertFragment newInstance(int title){
            FireAlertFragment fragment = new FireAlertFragment();
        ...
        public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
            final View view =  inflater.inflate(R.layout.dialog_fire, container,false);
